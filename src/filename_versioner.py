...
#
#     @classmethod
#     def find_base_and_version(cls, dir, basename, ext_name):
#         path_search = os.path.join(dir, f'{basename}.*{ext_name}')
#         versions = glob.glob(path_search)
#
#         # early return
#         if len(versions) < 1:
#             return None, None
...
#         m = re.search(cls.filename_regex(basename, ext_name), last_version)
#         # return filename and version part
#         return m.group(0), m.group(2)
#
#     @classmethod
#     def find_latest_path(cls, dir, basename, ext_name):
#         f, _ = cls.find_base_and_version(dir, basename, ext_name)
#         return f'{dir}/{f}' if f else None
#
